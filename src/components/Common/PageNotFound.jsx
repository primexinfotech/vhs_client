...
const PageNotFound = () => {
    ...
    return (
        <div className="flex h-screen w-full items-center justify-center bg-yellow-50 text-center">
            <div className="m-auto mt-24">
                ...
                <div className="mt-6">
                    <span onClick={() => navigate(-1)} className="rounded-md bg-zinc-700 p-3 text-xl text-yellow-400 hover:shadow-md hover:text-white cursor-pointer">Go back </span>
                </div>
            </div>
        </div>
    )
