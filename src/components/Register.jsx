    ...
    return (
        <div className="flex min-h-screen relative" style={{ backgroundColor: "#CEE5ED" }}>
            ...
            <div className="w-full md:w-5/12 bg-white flex flex-col justify-center px-6 md:px-20 ml-auto min-h-screen overflow-y-auto">
                ...
                <div className="py-8">
                    <h2 className="text-md font-bold text-gray-800 mb-1 text-center md:text-left">
                        Register to VHS
                    </h2>
                    <p className="text-xs text-gray-600 mb-6 text-center md:text-left">
                        Register to start using VHS
                    </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="relative block w-full">
                                <span className="text-gray-800 text-xs font-medium">Email</span>
                                <span className="absolute inset-y-0 left-0 flex items-center pl-3 mt-6 text-gray-500">
                        ...
                        <div>
                            <label className="relative block w-full">
                                <span className="text-gray-800 text-xs font-medium">Phone</span>
                                <span className="absolute inset-y-0 left-0 flex items-center pl-3 mt-6 text-gray-500">
                        ...
                        <div>
                            <label className="relative block w-full">
                                <span className="text-gray-800 text-xs font-medium">Confirm Password</span>
                                <span className="absolute inset-y-0 left-0 flex items-center pl-3 mt-6 text-gray-500">
                                    <i className="fa fa-lock" />
                                </span>
                                <input
                        ...
                        <div className="flex items-center justify-between">
                            <label className="inline-flex items-center">
                                ...
                                <span className="ml-2 text-gray-700 text-xs">I agree to the <span className="text-blue-600 hover:underline cursor-pointer">Terms and Conditions</span> &  <span className="text-blue-600 hover:underline cursor-pointer">Privacy Policy</span></span>
                            </label>
                        </div>
                    ...
                    <div className="mt-3 text-xs font-medium text-center md:text-left">
